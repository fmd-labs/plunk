...
| Variable                    | Required | Description                                                                                                         | Default |
| --------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------- | ------- |
| `EMAIL_BODY_RETENTION_DAYS` | No       | Days a sent email keeps its rendered HTML body before the daily cleanup clears it; the email itself is kept. `0` keeps every body. | `90`    |
